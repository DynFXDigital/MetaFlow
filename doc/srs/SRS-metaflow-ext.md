...
| REQ-0305 | Files TreeView | Display effective files grouped by classification (live-ref vs materialized). | Phase-4 | Files TreeView shows two groups with correct file count. | | P2 | Draft |
