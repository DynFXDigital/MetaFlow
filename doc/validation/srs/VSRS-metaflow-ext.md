...
|---|---|---|---|---|---|
| VREQ-0001 | Activation with DFX config | Extension activates when a workspace contains a valid `.ai-sync.json` pointing to DFX-AI-Metadata. | Extension activates; sidebar views populated; no errors in output channel. | P1 | Draft |
