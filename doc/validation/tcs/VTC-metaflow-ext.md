...
|---|---|---|---|---|---|---|---|
| VTC-0001 | Activation with DFX config | Workspace with .metaflow.json pointing to DFX-AI-Metadata | Open workspace; observe activation | Extension active; views populated; no errors | VREQ-0001 | P1 | Ready |
