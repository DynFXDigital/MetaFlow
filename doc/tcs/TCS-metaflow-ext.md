...
|---|---|---|---|---|---|---|---|---|---|
| TC-0300 | Extension is present | Test workspace | `getExtension('metaflow.metaflow')` | Extension found | Integration | Critical | Pass | `test/integration/extension.test.ts` | Phase 4 |
