...
This plan integrates `Capability` as a first-class MetaFlow concept by starting small: standardizing terminology and publishing an example AI metadata repository structure. The initial effort is documentation-first and non-breaking. It establishes a stable conceptual model that can later drive schema, CLI, and engine evolution.
...
4. Align core concept documentation to capability-first wording.
...
3. Preserve vendor-neutral framing for future ecosystem support.
...
3. Agreement on canonical terms before implementation work starts.
...
|---|---|---|---|
| 1 | Terminology Foundation | Canonical definitions and glossary alignment | Not started |
| 2 | Repository Example Structure | Minimal capability-based AI metadata layout | Not started |
| 3 | Adoption and Transition Guidance | Migration language and follow-up implementation backlog | Not started |
