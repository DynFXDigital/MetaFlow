...
- [Support matrix for custom instructions](https://docs.github.com/en/copilot/reference/custom-instructions-support)
- [Prompt files (customization library)](https://docs.github.com/en/copilot/tutorials/customization-library/prompt-files)
- [Custom instructions (customization library)](https://docs.github.com/en/copilot/tutorials/customization-library/custom-instructions)
...
## Visual Studio Code Docs (authoritative for VS Code behavior)
...
## GitHub Blog / Changelog (timeline and product framing)

- [Copilot supports Agent Skills (release)](https://github.blog/changelog/2025-12-18-github-copilot-now-supports-agent-skills/)
- [Custom agents product framing](https://github.blog/news-insights/product-news/your-stack-your-rules-introducing-custom-agents-in-github-copilot-for-observability-iac-and-security/)

## Community patterns (non-normative)

- [Awesome Copilot](https://github.com/github/awesome-copilot)

## Versioning

- Last reviewed: 2026-05-22# AI metadata references
