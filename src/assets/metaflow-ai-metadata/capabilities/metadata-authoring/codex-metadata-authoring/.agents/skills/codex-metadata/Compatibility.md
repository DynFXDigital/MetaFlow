...
- Current plugin packaging guidance documents skills, MCP server config, apps, and hooks as bundled component surfaces; do not assume Copilot instructions or agents can be repackaged as Codex plugin rules or subagents.
