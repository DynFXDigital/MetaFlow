...
- Treat auto memory as machine-local and complementary, not as a replacement for committed repository metadata.# Reflection + reinforcement for Claude Code metadata
