...
- `.github/skills/agent-skills/SKILL.md` is the concise progressive-discovery entry point.
- `.github/skills/agent-skills/references/SOURCES.md` records the authoritative live specification and pinned bundled snapshot.
...
Start with [the Agent Skills guidance](.github/skills/agent-skills/SKILL.md), then consult its [source index](.github/skills/agent-skills/references/SOURCES.md) and raw reference for exact details.
