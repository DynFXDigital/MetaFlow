...
- `MetaFlow: Open Codex Projection Boundary Review` opens a focused Markdown document for Codex file-backed, runtime-only, unsupported, not-achievable, and expected-evidence boundaries.
- `MetaFlow: Open Codex Runtime Evidence Review Queue` opens focused runtime evidence triage for all runtime-only concepts, release-ready blockers, or individual gate queues.
...
- `MetaFlow: Save Codex Runtime Evidence Template Records` writes selected runtime evidence scaffold files under `.metaflow/runtime-evidence` only after explicit confirmation, with overwrite protection for existing records.
...
| `MetaFlow: Open Codex Projection Boundary Review` | Open focused repository projection boundary review for Codex file-backed, runtime-only, unsupported, and not-achievable surfaces |                |
| `MetaFlow: Open Codex Runtime Evidence Review Queue` | Open focused runtime evidence triage for all runtime-only concepts, release-ready blockers, or individual gate queues |                |
