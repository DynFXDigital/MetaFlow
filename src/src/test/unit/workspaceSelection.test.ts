...
suite('Workspace Selection', () => {
    ...
    test('prefers active folder when multiple folders contain .metaflow/config.jsonc', () => {
        ...
        const selected = pickWorkspaceFolder([alpha, beta], beta, () => true);
    ...
    test('uses active folder when no folders contain .metaflow/config.jsonc', () => {
        ...
        const selected = pickWorkspaceFolder([alpha, beta], beta, () => false);
    ...
    test('falls back to first folder when no config exists and no active folder', () => {
        ...
        const selected = pickWorkspaceFolder([alpha, beta], undefined, () => false);
