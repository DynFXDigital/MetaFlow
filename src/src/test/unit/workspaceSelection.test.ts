...
suite('Workspace Selection', () => {
    ...
    test('prefers the only folder containing .ai-sync.json', () => {
    ...
    test('prefers active folder when multiple folders contain .ai-sync.json', () => {
        const alpha = folder('/workspace/alpha');
        const beta = folder('/workspace/beta');
    ...
    test('uses active folder when no folders contain .ai-sync.json', () => {
        const alpha = folder('/workspace/alpha');
        const beta = folder('/workspace/beta');
