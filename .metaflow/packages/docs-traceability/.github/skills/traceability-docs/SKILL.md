...
- This package includes both `test-tcs.instructions.md` and `ft-tcs.instructions.md` for consumer compatibility.
- Prefer `test-tcs.instructions.md` when selecting a single primary TCS guidance source.
