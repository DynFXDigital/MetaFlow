...
- Report `.codex/rules/*.rules` files as the Codex `commandRules` projection concept and apply command-rule target adapter gates separately from project config.
