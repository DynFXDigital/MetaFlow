...
function validateManifestFields(fields: ManifestFields, filePath?: string): CapabilityWarning[] {
    ...
    if (fields.license) {
        ...
        const licenseIsValid =
            trimmed === FALLBACK_LICENSE_TOKEN ||
            isLikelySpdxExpression(trimmed);
 ...
 */
export function loadCapabilityManifestForLayer(layerPath: string, capabilityId: string): CapabilityMetadata | undefined {
