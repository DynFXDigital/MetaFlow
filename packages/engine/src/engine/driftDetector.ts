 ...
 * @param outputDir Materialization output directory (e.g., `.github`).
 * @param relativePath Relative path of the materialized file.
 ...
 *
 * @param workspaceRoot Absolute workspace root.
 * @param outputDir Materialization output directory.
 * @param state Current managed state.
