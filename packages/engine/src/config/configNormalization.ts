...
function orderProfileLayerOverride(
    override: ProfileLayerOverride,
): ProfileLayerOverride {
    return {
...
function cloneCapabilitySource(source: CapabilitySource): CapabilitySource {
    return {
        ...
        ...(source.excludedTypes !== undefined
            ...
            : {}),
        ...(source.injection !== undefined ? { injection: orderInjectionConfig(source.injection) } : {}),
    };
}
...
function cloneNamedRepo(
    ...
    return {
        ...
        ...(repo.discover !== undefined ? { discover: orderRepoDiscoveryConfig(repo.discover) } : {}),
        ...(repo.injection !== undefined ? { injection: orderInjectionConfig(repo.injection) } : {}),
        capabilities,
    };
}
...
function buildRestOfConfig(
    ...
    return {
        ...
        ...(config.injection !== undefined ? { injection: orderInjectionConfig(config.injection) } : {}),
