...
- The VS Code command `MetaFlow: Open Codex Runtime Evidence Template` opens review-only JSON templates for selected runtime-only Codex concepts from the current support-boundary action plan, without creating proof or writing canonical evidence records.
