...
- The VS Code command `MetaFlow: Open Codex Runtime Evidence Review Queue` opens a focused triage document for all runtime-only concepts, release-ready blockers, missing evidence, diagnostics, error diagnostics, expired evidence, stale adapter version evidence, failed evidence, not-run evidence, or waived evidence.
